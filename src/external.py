...
This file holds the outbound API calls that the UI team can later use.  It is
meant to be imported into any external application

The contents of this class shall not depend on anything external.  It must be
self contained.
...
# Add this before loading your models
...
class External_Model_Interface:
    def __init__(
        ...
        if "save_version" in self.model and self.model["save_version"] == os.getenv(
            ...
            # an error was given previosuly, but its too distracting
            pass
