    ...
    if not found:
        ...
        "Test-Performance Testing", "Test-Security Testing", "Test-Usability Testing", "Test-Regression Testing") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ...
            (
                ...
                domains,
                subdomains,
                domain_counts["Application"],
                domain_counts["Application Performance Manager"],
                domain_counts["Big Data"],
                domain_counts["Cloud"],
                domain_counts["Computer Graphics"],
                domain_counts["Data Structure"],
                domain_counts["Databases"],
                domain_counts["Software Development and IT Operations"],
                domain_counts["Error Handling"],
                domain_counts["Event Handling"],
                domain_counts["Geographic Information System"],
                domain_counts["Input-Output"],
                domain_counts["Interpreter"],
                domain_counts["Internationalization"],
                domain_counts["Logic"],
                domain_counts["Language"],
                domain_counts["Logging"],
                domain_counts["Machine Learning"],
                domain_counts["Microservices/Services"],
                domain_counts["Multimedia"],
                domain_counts["Multi-Thread"],
                domain_counts["Natural Language Processing"],
                domain_counts["Network"],
                domain_counts["Operating System"],
                domain_counts["Parser"],
                domain_counts["Search"],
                domain_counts["Security"],
                domain_counts["Setup"],
                domain_counts["User Interface"],
                domain_counts["Utility"],
                domain_counts["Test"],
                subdomain_counts["Application-Integration"],
                subdomain_counts["Application-Plugin Management"],
                subdomain_counts["Application-User Customization"],
                subdomain_counts["Application-App Configuration"],
                subdomain_counts["Application-Version Control"],
                subdomain_counts["Application-Compatibility Checks"],
                subdomain_counts[
                    "Application Performance Manager-Performance Monitoring"
                ],
                subdomain_counts["Application Performance Manager-Resource Allocation"],
                subdomain_counts["Application Performance Manager-Error Detection"],
                subdomain_counts["Application Performance Manager-Load Balancing"],
                subdomain_counts["Application Performance Manager-Traffic Management"],
                subdomain_counts["Application Performance Manager-Diagnostic Tools"],
                subdomain_counts["Big Data-Data Processing"],
                subdomain_counts["Big Data-Data Storage"],
                subdomain_counts["Big Data-Data Analysis"],
                subdomain_counts["Big Data-Real-Time Processing"],
                subdomain_counts["Big Data-Batch Processing"],
                subdomain_counts["Big Data-Data Visualization"],
                subdomain_counts["Cloud-Resource Management"],
                subdomain_counts["Cloud-Virtualization"],
                subdomain_counts["Cloud-Scalability Solutions"],
                subdomain_counts["Cloud-Cloud Security"],
                subdomain_counts["Cloud-Data Migration"],
                subdomain_counts["Cloud-Service Configuration"],
                subdomain_counts["Computer Graphics-Image Rendering"],
                subdomain_counts["Computer Graphics-Animation"],
                subdomain_counts["Computer Graphics-Modeling"],
                subdomain_counts["Computer Graphics-Texture Mapping"],
                subdomain_counts["Computer Graphics-Visual Effects"],
                subdomain_counts["Computer Graphics-Graphics Optimization"],
                subdomain_counts["Data Structure-Linear Structures"],
                subdomain_counts["Data Structure-Tree Structures"],
                subdomain_counts["Data Structure-Graph Structures"],
                subdomain_counts["Data Structure-Data Sorting"],
                subdomain_counts["Data Structure-Search Algorithms"],
                subdomain_counts["Data Structure-Data Manipulation"],
                subdomain_counts["Databases-Query Execution"],
                subdomain_counts["Databases-Transaction Management"],
                subdomain_counts["Databases-Schema Design"],
                subdomain_counts["Databases-Database Security"],
                subdomain_counts["Databases-Backup and Recovery"],
                subdomain_counts["Databases-Database Optimization"],
                subdomain_counts[
                    "Software Development and IT Operations-Continuous Integration"
                ],
                subdomain_counts[
                ...
                subdomain_counts["Error Handling-Exception Handling"],
                subdomain_counts["Error Handling-Error Logging"],
                subdomain_counts["Error Handling-Fault Tolerance"],
                subdomain_counts["Error Handling-Debugging Tools"],
                subdomain_counts["Error Handling-User Notification"],
                subdomain_counts["Error Handling-Error Prevention"],
                subdomain_counts["Event Handling-User Interactions"],
                subdomain_counts["Event Handling-System Events"],
                subdomain_counts["Event Handling-Event Logging"],
                subdomain_counts["Event Handling-Event Driven Processing"],
                subdomain_counts["Event Handling-Notifications"],
                subdomain_counts["Event Handling-Asynchronous Processing"],
                subdomain_counts["Geographic Information System-Mapping"],
                subdomain_counts["Geographic Information System-Spatial Analysis"],
                subdomain_counts["Geographic Information System-Data Collection"],
                subdomain_counts[
                    "Geographic Information System-Geographic Visualization"
                ],
                subdomain_counts["Geographic Information System-Location Services"],
                subdomain_counts[
                    "Geographic Information System-Environmental Modeling"
                ],
                subdomain_counts["Input-Output-Data Reading"],
                subdomain_counts["Input-Output-Data Writing"],
                subdomain_counts["Input-Output-Stream Management"],
                subdomain_counts["Input-Output-Buffering Strategies"],
                subdomain_counts["Input-Output-File Management"],
                subdomain_counts["Input-Output-Network IO"],
                subdomain_counts["Interpreter-Script Execution"],
                subdomain_counts["Interpreter-Code Translation"],
                subdomain_counts["Interpreter-Memory Management"],
                subdomain_counts["Interpreter-Syntax Analysis"],
                subdomain_counts["Interpreter-Optimization"],
                subdomain_counts["Interpreter-Debugging"],
                subdomain_counts["Internationalization-Localization"],
                subdomain_counts["Internationalization-Language Support"],
                subdomain_counts["Internationalization-Cultural Adaptation"],
                subdomain_counts["Internationalization-Currency Conversion"],
                subdomain_counts["Internationalization-Date/Time Formatting"],
                subdomain_counts["Internationalization-Right-to-Left Layouts"],
                subdomain_counts["Logic-Control Structures"],
                subdomain_counts["Logic-Algorithm Implementation"],
                subdomain_counts["Logic-Logic Optimization"],
                subdomain_counts["Logic-Validation Checks"],
                subdomain_counts["Logic-Rule Processing"],
                subdomain_counts["Logic-Decision Making"],
                subdomain_counts["Language-Syntax Features"],
                subdomain_counts["Language-Compiler/Interpreter Enhancements"],
                subdomain_counts["Language-Runtime Optimization"],
                subdomain_counts["Language-Standard Libraries"],
                subdomain_counts["Language-Language Extensions"],
                subdomain_counts["Language-Type Systems"],
                subdomain_counts["Logging-Event Logging"],
                subdomain_counts["Logging-System Monitoring"],
                subdomain_counts["Logging-Performance Tracking"],
                subdomain_counts["Logging-Error Logs"],
                subdomain_counts["Logging-User Activity Logs"],
                subdomain_counts["Logging-Audit Trails"],
                subdomain_counts["Machine Learning-Training Models"],
                subdomain_counts["Machine Learning-Prediction"],
                subdomain_counts["Machine Learning-Data Preprocessing"],
                subdomain_counts["Machine Learning-Feature Extraction"],
                subdomain_counts["Machine Learning-Model Evaluation"],
                subdomain_counts["Machine Learning-Deployment"],
                subdomain_counts["Microservices/Services-Service Discovery"],
                subdomain_counts["Microservices/Services-Load Balancing"],
                subdomain_counts["Microservices/Services-API Gateway"],
                subdomain_counts["Microservices/Services-Service Communication"],
                subdomain_counts["Microservices/Services-Fault Tolerance"],
                subdomain_counts["Microservices/Services-Service Deployment"],
                subdomain_counts["Multimedia-Media Playback"],
                subdomain_counts["Multimedia-Media Editing"],
                subdomain_counts["Multimedia-Encoding and Decoding"],
                subdomain_counts["Multimedia-Streaming"],
                subdomain_counts["Multimedia-Content Delivery"],
                subdomain_counts["Multimedia-Media Storage"],
                subdomain_counts["Multi-Thread-Concurrency Control"],
                subdomain_counts["Multi-Thread-Synchronization"],
                subdomain_counts["Multi-Thread-Thread Safety"],
                subdomain_counts["Multi-Thread-Parallel Processing"],
                subdomain_counts["Multi-Thread-Resource Sharing"],
                subdomain_counts["Multi-Thread-Deadlock Resolution"],
                subdomain_counts["Natural Language Processing-Text Analysis"],
                subdomain_counts["Natural Language Processing-Speech Recognition"],
                subdomain_counts["Natural Language Processing-Language Generation"],
                subdomain_counts["Natural Language Processing-Sentiment Analysis"],
                subdomain_counts["Natural Language Processing-Machine Translation"],
                subdomain_counts["Natural Language Processing-Chatbot Interfaces"],
                subdomain_counts["Network-Protocol Implementation"],
                subdomain_counts["Network-Connection Management"],
                subdomain_counts["Network-Data Transmission"],
                subdomain_counts["Network-Network Security"],
                subdomain_counts["Network-Bandwidth Optimization"],
                subdomain_counts["Network-Network Monitoring"],
                subdomain_counts["Operating System-Process Management"],
                subdomain_counts["Operating System-Memory Management"],
                subdomain_counts["Operating System-Device Drivers"],
                subdomain_counts["Operating System-File Systems"],
                subdomain_counts["Operating System-User Interface"],
                subdomain_counts["Operating System-System Security"],
                subdomain_counts["Parser-Syntax Parsing"],
                subdomain_counts["Parser-Error Recovery"],
                subdomain_counts["Parser-Data Conversion"],
                subdomain_counts["Parser-Optimization"],
                subdomain_counts["Parser-Code Generation"],
                subdomain_counts["Parser-Validation"],
                subdomain_counts["Search-Indexing"],
                subdomain_counts["Search-Query Processing"],
                subdomain_counts["Search-Ranking"],
                subdomain_counts["Search-Optimization"],
                subdomain_counts["Search-Caching"],
                subdomain_counts["Search-Personalization"],
                subdomain_counts["Security-Authentication"],
                subdomain_counts["Security-Authorization"],
                subdomain_counts["Security-Encryption"],
                subdomain_counts["Security-Intrusion Detection"],
                subdomain_counts["Security-Compliance"],
                subdomain_counts["Security-Data Integrity"],
                subdomain_counts["Setup-Installation"],
                subdomain_counts["Setup-Configuration"],
                subdomain_counts["Setup-System Requirements"],
                subdomain_counts["Setup-Update Management"],
                subdomain_counts["Setup-Licensing"],
                subdomain_counts["Setup-Environment Setup"],
                subdomain_counts["User Interface-Layout Design"],
                subdomain_counts["User Interface-Interaction Design"],
                subdomain_counts["User Interface-Accessibility"],
                subdomain_counts["User Interface-Animation"],
                subdomain_counts["User Interface-Responsive Design"],
                subdomain_counts["User Interface-User Feedback"],
                subdomain_counts["Utility-Data Conversion"],
                subdomain_counts["Utility-System Tools"],
                subdomain_counts["Utility-Automation Scripts"],
                subdomain_counts["Utility-Performance Tools"],
                subdomain_counts["Utility-Diagnostic Utilities"],
                subdomain_counts["Utility-Backup Tools"],
                subdomain_counts["Test-Unit Testing"],
                subdomain_counts["Test-Integration Testing"],
                subdomain_counts["Test-Performance Testing"],
                subdomain_counts["Test-Security Testing"],
                subdomain_counts["Test-Usability Testing"],
                subdomain_counts["Test-Regression Testing"],
            ),
        )
        conn.commit()
    cur.close()
